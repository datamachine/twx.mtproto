...
ResPQ = BoxedType.new('ResPQ', ResPQ_t)
...
P_Q_inner_data = BoxedType.new('P_Q_inner_data', P_Q_inner_data_t)
...
Server_DH_Params = BoxedType.new('Server_DH_Params', Server_DH_Params_t)
...
Server_DH_inner_data = BoxedType.new('Server_DH_inner_data', Server_DH_inner_data_t)
...
Client_DH_Inner_Data = BoxedType.new('Client_DH_Inner_Data', Client_DH_Inner_Data_t)
...
Set_client_DH_params_answer = BoxedType.new('Set_client_DH_params_answer', Set_client_DH_params_answer_t)
...
RpcResult = BoxedType.new('RpcResult', RpcResult_t)
...
RpcError = BoxedType.new('RpcError', RpcError_t)
...
RpcDropAnswer = BoxedType.new('RpcDropAnswer', RpcDropAnswer_t)
...
FutureSalt = BoxedType.new('FutureSalt', FutureSalt_t)
...
FutureSalts = BoxedType.new('FutureSalts', FutureSalts_t)
...
Pong = BoxedType.new('Pong', Pong_t)
...
DestroySessionRes = BoxedType.new('DestroySessionRes', DestroySessionRes_t)
...
NewSession = BoxedType.new('NewSession', NewSession_t)
...
Message = BoxedType.new('Message', Message_t)
...
MessageContainer = BoxedType.new('MessageContainer', MessageContainer_t)
...
MessageCopy = BoxedType.new('MessageCopy', MessageCopy_t)
...
TLType = BoxedType.new('TLType', TLType_t)
...
MsgsAck = BoxedType.new('MsgsAck', MsgsAck_t)
...
BadMsgNotification = BoxedType.new('BadMsgNotification', BadMsgNotification_t)
...
MsgResendReq = BoxedType.new('MsgResendReq', MsgResendReq_t)
...
MsgsStateReq = BoxedType.new('MsgsStateReq', MsgsStateReq_t)
...
MsgsStateInfo = BoxedType.new('MsgsStateInfo', MsgsStateInfo_t)
...
MsgsAllInfo = BoxedType.new('MsgsAllInfo', MsgsAllInfo_t)
...
MsgDetailedInfo = BoxedType.new('MsgDetailedInfo', MsgDetailedInfo_t)
